  ...
  <table class="table table-hover">
    ...
    <tbody>
        <c:forEach var="communityVO" items="${list }" varStatus="info">
          <c:set var="communityno" value="${communityVO.communityno }" />
          <c:set var="thumb1" value="${communityVO.thumb1 }" />
    
          <tr onclick="location.href='./read.do?communityno=${communityno}'" style="cursor: pointer;">
            <td>
              <c:choose>
            ...
            <td class="td_bs">
              <a href="#" title="삭제"><img src="/community/images/map.png" class="icon"></a>
              <a href="#" title="삭제"><img src="/community/images/youtube.png" class="icon"></a>
