...
<c:set var="planID" value="${param.planID }" /> <%-- mav.addObject("planID", contentsVO.getCateno()); // redirect parameter 적용 --%>
  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do?planID=${planID}'" class="btn btn-secondary btn-sm">새로운 컨텐츠 등록</button>
        <button type='button' onclick="location.href='./list_by_planID.do?planID=${planID}'" class="btn btn-secondary btn-sm">목록</button>
        <button type='button' onclick="location.href='./list_by_planID_grid.do?planID=${planID}'" class="btn btn-secondary btn-sm">갤러리 목록</button>
      </LI>
    </UL>
  </fieldset>
