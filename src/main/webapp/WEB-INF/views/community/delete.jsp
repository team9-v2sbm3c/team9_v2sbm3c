...
<c:set var="thumb1" value="${communityVO.cimage.toLowerCase() }" />
...
<c:import url="../menu/top.do" />
  <DIV class='title_line'> ${planVO.pname } > ${title } > 삭제</DIV>
        ...
        <DIV style='text-align: center; width: 50%; float: left;'>
          ...
          <c:choose>
            <c:when test="${thumb1.endsWith('jpg') || thumb1.endsWith('png') || thumb1.endsWith('gif')}">
              <img src="/community/storage/${file1saved }" style='width: 90%;'> 
            </c:when>
