			...
			<div class="collapse navbar-collapse" id="mynavbar">
				<ul class="navbar-nav me-auto">
					<li class="nav-item dropdown"><a
						class="nav-link top_menu_link dropdown-bs-toggle"
						data-bs-toggle="dropdown" href="#">회원</a>
						<div class="dropdown-menu">
							<c:choose>
								<c:when test="${sessionScope.id == null }">
									<a class="dropdown-item" href="/guest/create.do">회원 가입</a>
									<a class="dropdown-item" href="javascript: alert('개발 예정')">아이디
										찾기</a>
									<a class="dropdown-item" href="javascript: alert('개발 예정')">비밀번호
										찾기</a>
								</c:when>
								<c:otherwise>
									<a class="dropdown-item" href="/guest/read.do">가입 정보</a>
									<a class="dropdown-item" href="/guest/passwd_update.do">비밀번호
										변경</a>
					...
					<li class="nav-item"><c:choose>
							...
							<c:otherwise>
								<a class="nav-link top_menu_link" href='/guest/logout.do'>${sessionScope.id }
									로그아웃</a>
							</c:otherwise>
						</c:choose></li>
					<c:choose>
